(function () {
    ...
    const translations = {
      pt: {
        ...
        'hero-title': 'Inovação, Código & Branding Sob Medida',
        'about-tag': 'Sobre', 'about-subtitle': 'Desenvolvemos sistemas e experiências digitais focadas em resolver problemas reais.',
        'about-badge': 'Startup <br>Tecnológica',
        'about-heading': 'Desenvolvimento de software de alta performance e identidade de marca',
        'about-text': 'Fundada por uma equipe técnica dedicada, a Renovancy nasceu para transformar desafios em softwares modernos e marcas de valor. Desenvolvemos o sistema administrativo e a presença web da Consuat, aliando agilidade, código sob medida e design estratégico para impulsionar empresas no mercado.',
        ...
        'pf1-title': 'Painel Administrativo Consuat', 'pf2-title': 'Manual de Identidade Visual', 'pf3-title': 'Plataforma Web Institucional', 'pf4-title': 'Uniforme Corporativo', 'pf5-title': 'Sistema de Gestão Integrada', 'pf6-title': 'Material Gráfico & Papelaria', 'pf7-title': 'Landing Page de Alta Conversão', 'pf8-title': 'Mockups Corporativos', 'pf9-title': 'Aplicativo Mobile Corporativo',
      ...
      en: {
        ...
        'hero-title': 'Innovation, Code & Tailored Branding',
        'about-tag': 'About', 'about-subtitle': 'We develop systems and digital experiences focused on solving real-world challenges.',
        'about-badge': 'Tech <br>Startup',
        'about-heading': 'High-performance software development and brand identity',
        'about-text': 'Founded by a dedicated technical team, Renovancy was born to turn challenges into modern software and valuable brands. We developed the administrative system and web presence for Consuat, combining agility, custom code, and strategic design.',
        ...
        'pf1-title': 'Consuat Admin Dashboard', 'pf2-title': 'Brand Identity Guidelines', 'pf3-title': 'Corporate Web Platform', 'pf4-title': 'Corporate Uniform', 'pf5-title': 'Integrated Management System', 'pf6-title': 'Print & Stationery Design', 'pf7-title': 'High Conversion Landing Page', 'pf8-title': 'Corporate Mockups', 'pf9-title': 'Corporate Mobile App',
